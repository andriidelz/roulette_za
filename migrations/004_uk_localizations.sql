...
Вам не вистачає %d балів, щоб взяти участь у розподілі щотижневої нагороди.'),
    ...
    ('withdrawusdtcheck', 'uk', 'В вашому акаунті вказаний такий адрес для виводу USDT %s. Перевірте і підтвердіть адресу чи змініть її. Відправку USDT на неправильну адресу неможливо відмінити.'),
