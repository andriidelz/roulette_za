...
Вам не вистачає %d балів, щоб взяти участь у розподілі щотижневої нагороди.'),
    ...
    ('username_points', 'uk', '<b>%s</b> - %d балів'),
    ('username_points_efficiency', 'uk', '<b>%s</b> - %d балів (%.1f%%)'),
...
INSERT INTO localizations (key, language, value) VALUES
    ...
    ('name_changeno_msg_start', 'uk', '✅ <b>Твоє ігрове ім’я збережено!</b> Щоб безкоштовно взяти участь у розіграші щотижневого призового фонду, підпишись на наш резервний канал. Він використовується лише у разі проблем із доступом до основного бота — щоб ми завжди залишалися на зв’язку.'),
    ...
    ('name_changesave_msg_start', 'uk', '✅ <b>Нове ігрове ім’я для рейтингу збережено!</b> Щоб безкоштовно взяти участь у боротьбі за щотижневий призовий фонд, підпишись на наш резервний канал, щоб залишатися на зв’язку. Він використовується лише у разі проблем із доступом до основного бота — щоб ми завжди залишалися на зв’язку.'),
...
INSERT INTO localizations (key, language, value) VALUES
    ...
    ('captcha_text', 'uk', 'Ваша активність дуже висока. Будь ласка підтвердьте що ви не робот.'),
    ('captcha_correct', 'uk', 'Вітаємо з успішним проходженням капчі! На майбутнє постарайтеся взаємодіяти з ботом акуратніше'),
    ('startmessage1_new', 'uk', 'Вітаємо тебе в  🐙 <b> Sprut Black & Red </b> 
Це безкоштовна гра у Telegram-боті, яка щотижня дозволяє вигравати  <b><i>💵реальні фінансові призи</i></b> за віртуальні вгадування!

1️⃣ Реєструйся у боті
2️⃣ Вгадуй, що випаде на рулетці - 🔴червоне, ⚫️чорне чи 🟢Zero
3️⃣ Отримуй бали у рейтинг за вірне вгадування, щоб отримати більшу $ винагороду

📢<b> Sprut Black & Red має унікальні переваги:</b> 
▪️<i>Щотижневий призовий фонд, виплати щопонеділка;</i>
▪️<i>Відсутність верифікації;</i>
▪️<i>Відсутність депозитів чи будь-якої оплати за участь</i>
▪️ <i>Можливість моментального виводу винагороди - ніяких airdropiв, токенів та довгих очікувань;</i>
▪️ <i>Прозора система розіграшу, з можливістю незалежної перевірки кожного вгадування.</i>

❗️Це не жарт і не клікбейт. Просто крути рулетку в  🐙 <b> Sprut Black & Red </b>   — без вкладень, без ризиків, із шансом  розділити 💰призовий фонд у {prize_fund}$ щотижня!

👇 <b>Щоб розпочати — натисни кнопку <u>«Реєстрація»</u> щоб підтвердити вік</b>'),
    ('btn_reg', 'uk', '🐙 Завершити реєстрацію'),
    ('bet_inactive', 'uk', 'Прийняття ставок зупинено через вашу бездіяльність. Щоб почати грати, натисніть кнопку Грати в меню.');