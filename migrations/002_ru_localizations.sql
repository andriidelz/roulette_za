...
Вам не хватает %d баллов, чтобы принять участие в распределении еженедельной награды.'),
    ...
    ('withdrawusdtcheck', 'ru', 'В вашем аккаунте указан такой адрес для вывода USDT %s. Проверьте и подтвердите адрес или измените его. Отправку USDT на неверный адрес невозможно отменить.'),
