...
Here you can change your profile settings:'),
    ...
    ('withdrawusdtchange', 'en', 'Please reply with a new address for USDT TRC20 withdrawal in one message without spaces. Check the address carefully – sending USDT to an incorrect address cannot be canceled.'),
    ('withdrawusdtchangeok', 'en', 'Your USDT TRC20 withdrawal address has been successfully changed.'),
    ('withdrawusdtchangeerror', 'en', 'You have entered an incorrect USDT TRC20 address. Please check the address again and send it in your next message.'),
    ...
    ('statistics_next', 'en', 'Select another time period to get statistics or return to the main menu'),
...
You need %d more points to participate in the distribution of the weekly reward.'),
    ...
    ('username_points', 'en', '<b>%s</b> - %d points'),
    ('username_points_efficiency', 'en', '<b>%s</b> - %d points (%.1f%%)'),
    ...
    ('withdrawcancel', 'en', 'Cancel input'),
    ...
    ('withdrawusdtsumstop', 'en', 'If you want to stop the output, you can cancel the input and stay in the current menu or return to the main menu.'),
...
INSERT INTO localizations (key, language, value) VALUES
    ...
    ('balance_updated_message', 'en', 'You have received a reward of {amount} to your internal balance! Your current balance: {balance}.'),
    ('top_rating_title', 'en', 'Weekly Top Rating'),
    ('top_rating_message', 'en', 'Congratulations! You are now in the weekly top rating at position {position}! You earned {points} points. The total prize fund is {prize_fund}.'),
